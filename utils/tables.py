...
db.define_table('Carpetas_BN',
    ...
    Field('Latitud',type='decimal'),
    Field('Longitud',type='decimal'),
...
db.define_table('Coeficientes',
    ...
    Field('Creci_Pi_des',type='decimal'),
    ...
    Field('Creci_Pri_Gr',type='decimal'),
    Field('Creci_Pri_Gl',type='decimal'),
    Field('Creci_Pri_Ot',type='decimal'),
    Field('Creci_Seg_Gr',type='decimal'),
    Field('Creci_Seg_Gl',type='decimal'),
    Field('Creci_Seg_Ot',type='decimal'),
    Field('Creci_Eu_des',type='decimal'),
...
db.define_table('Parcelas_Otros',
    Field('Codigo',type='integer', unique=True, notnull=True),
    Field('Cod_Parcela',d.Parcelas),
    Field('Cod_Agente',type='string'),
    Field('GMD',type='decimal'),
    Field('Por_AA',type='decimal'),
    Field('Tipo',type='string'),
    Field('Pos',type='integer'),
    Field('GMD_Rnd',type='integer'),
    Field('A1',type='decimal'),
    Field('A2',type='decimal'),
    Field('A3',type='decimal'),
    Field('A4',type='decimal'),
    Field('A5',type='decimal'),
    Field('A6',type='decimal'),
    Field('A7',type='decimal'),
    Field('A8',type='decimal'),
    Field('A9',type='decimal'),
    Field('A10',type='decimal'),
    Field('A11',type='decimal'),
    Field('A12',type='decimal'),
    Field('A13',type='decimal'),
    Field('A14',type='decimal'),
    Field('A15',type='decimal'),
    Field('A16',type='decimal'),
    Field('A17',type='decimal'),
    Field('A18',type='decimal'),
    Field('A19',type='decimal'),
    Field('A20',type='decimal'),
    Field('A21',type='decimal'),
    Field('A22',type='decimal'),
    Field('A23',type='decimal'),
    Field('A24',type='decimal'),
    Field('A25',type='decimal')
)
...
db.define_table('Rodales',
    ...
    Field('Edad',type='decimal'),
    Field('Altura',type='decimal'),
    ...
    Field('Res_Cat1',type='decimal'),
    Field('Res_Cat2',type='decimal'),
    Field('Res_Cat3',type='decimal'),
    Field('Res_Cat4',type='decimal'),
    Field('Res_Cat5',type='decimal'),
    Field('Res_Fus1',type='decimal'),
    Field('Res_Fus2',type='decimal'),
    Field('Res_Fus3',type='decimal'),
    Field('Res_Fus4',type='decimal'),
    Field('Res_Fus5',type='decimal'),
